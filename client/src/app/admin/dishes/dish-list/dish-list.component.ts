...
export class DishListComponent  implements OnInit {
  ...
  private getcategorys() {
    this.shareService.getData(constants.getproduct).subscribe(
      results => {
  ...
  updateData(id, val) {
    this.shareService.update(constants.getproduct + id, val).subscribe(res => {
  ...
  deleteData(val) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.shareService.delete(constants.getproduct + val._id).subscribe(res => {
